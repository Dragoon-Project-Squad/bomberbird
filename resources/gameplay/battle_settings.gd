...
#CPU Settings
@export_enum ("Stationary", "Easy", "Medium", "Hard") var cpu_dfficulty
@export_enum ("None", "1", "2", "3", "4", "Fill") var cpu_count
...
@export_enum ("OFF", "ON", "SUPER") var MISOBON_SETTING: String
# Breakable Settings
...
@export_enum ("Preset", "None", "All", "Custom") var BREAKABLE_SPAWN_RULE: String
