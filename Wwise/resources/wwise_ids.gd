...
class EVENTS:
	...
	const PLAY_MUSIC_BATTLE : int = 230359828
	const PLAY_MUSIC_MAIN_MENU : int = 3968446557
	const STOP_MUSIC : int = 2837384057

class STATES:

	class BATTLE_TRACK:
		const GROUP : int = 896293863
	
		class STATE:
			const NONE : int = 748895195
			const BOUNTY_HUNTER_JAM : int = 3671065912
			const DAD_DRIVE : int = 3284605273
			const DUNGEON : int = 608898761
			const MINKI : int = 3432696479
			const RANDOM : int = 3048058352
			const RUSH : int = 2275039111
